...
x_start, y_start, z_start = 1770, 12500, mars_map[nr -round(12500 / escala), round(1770 / escala)]
x_end, y_end, z_end = 1770, 13000, mars_map[nr -round(13000 / escala), round(1770 / escala)]
