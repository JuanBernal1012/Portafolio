...
x_start, y_start, z_start = 4150, 570, mars_map[nr -round(570 / escala), round(4150 / escala)]
x_end, y_end, z_end = 4150, 5150, mars_map[nr -round(5150 / escala), round(4150 / escala)]
